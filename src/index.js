...
const logIn = async (page) => {
  await page.goto('https://www.omni7.jp/account/login/')

  await page.$eval('input[name="login"]', (el, mail) => { el.value = mail }, setting.omniSevenEmail)
  await page.$eval('input[name="password"]', (el, password) => { el.value = password }, setting.omniSevenPassword)
